...
{
	/// <summary>
	/// Implementation of Vlad2net.Crypto encoder
	/// </summary>
	public class CryptoEncoder: 
		ICryptoTransform
	{
		const byte life = 42;		//meaning of life (answer to everything) from hitchhikers guide - delta value used by Vlad2net.Crypto
		const byte death = 64;		//
		const byte escapeByte = 61;	//escape byte used by Vlad2net.Crypto
		...
		/// </summary>
		public CryptoEncoder(): this(128, new byte[] {}, false)
		{
		}

		public CryptoEncoder(int lineLength, byte[] escapeThese, bool CRLFAfter)
		{
